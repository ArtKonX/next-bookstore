        ...
        <div className={styles['add-form-block']}>
            <form className={`${dmSerifDisplay400.className} ${styles.form}`} onSubmit={(e) => { [handleSubmit(), e.preventDefault()] }}>
                ...
                <div className={styles['form__input-block']}>
                    ...
                    <input className={`${roboto.className} ${styles.input}`} value={title} onChange={(e) => setTitle(e.target.value)} />
                </div>
                ...
                <div className={styles['form__price-input-block']}>
                    ...
                    <input className={`${roboto.className} ${styles.input}`} type="text" value={yearOfWriting} onChange={(e) => setYearOfWriting(e.target.value.replaceAll(' ', ''))} />
                </div>

                <div className={styles['form__price-input-block']}>
                    <label className={styles['label-title']}>Стоимость книги:</label>
                    <input className={`${roboto.className} ${styles.input}`} type="text" value={price} onChange={(e) => setPrice(e.target.value.replaceAll(' ', ''))} />
                </div>
